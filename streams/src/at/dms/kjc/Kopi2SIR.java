    ...
    */    
                                          ...
                                          JExpression expr) 
    {
        ...
        if (retObj instanceof JUnqualifiedInstanceCreation) {
            ...
            //we need to add this definition to the symbol table
                ...
                SIRStream temp=(SIRStream)getVisitedOp(type.toString());
                //System.err.println("CLONNING var: "+temp);
         ...
         JClassDeclaration decl) 
    {
        ...
        */
        ...
        //System.err.println("CONNING anon: "+SIROp);
    ...
    private SIRInitStatement createInitStatement(Object SIROp, String regMethod) 
    {
        ...
        */
        ...
        if (SIROp instanceof JUnqualifiedInstanceCreation) {
            ...
            //if(!(st instanceof SIRRecursiveStub))
            //System.err.println("CLONNING: "+st);
                                            ...
                                            JExpression[] args) 
    {
	    ...
	    return null;
        ...
        else if (ident.equals("addSteadyPhase") || ident.equals("addInitPhase") || ident.equals("annotateIORate")) {
            ...
            // New syntax (originally driven by phased filters) for
            // setting I/O types.  This has two arguments, which are
            // null or Class objects.
            args[0] = (JExpression)args[0].accept(this);
